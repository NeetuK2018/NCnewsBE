const endPoints = {
  ...
  '/api/articles': {
    GET: 'shows all articles, also takes queries on limit, sort_by, order, and p(page)',
  },
  ...
  '/api/articles/:article_id/comments/:comment_id': {
    ...
    DELETE: 'deletes a comment specified by the comment_id and responds with no content',
  },
  '/api/users': {
    GET: 'displays all users',
    POST: 'allows a new user to be added {username, avatar_url, name}',
  },
  '/api/users/:username': { GET: 'shows a specific user by chosen username' },
